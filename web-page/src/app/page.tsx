    ...
    <div>
      ...
      <Body isOpen={isMenuOpen}>
        <div className='flex content-center justify-evenly'>
          ...
          />
          <PortraitCardReverse
            imageUrl = 'https://project42.sorokdva.eu/assets/images/carte1.png'
            text = "Membre de la Station \n Le membre d'équipage est le plus loyale des citoyens, et un très bon spationaute. Mais la nuit, il a besoin de sommeil."
          />
          <PortraitCard 
